...
impl Display for HttpVersion{
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            Self::Unknown(s) => if let Some(v) = s { write!(f, "{v}") } else { write!(f, "UNKNOWN/0.0") },
...
impl HttpVersion{
    #[inline] pub const fn is_unknown(&self) -> bool { match self { Self::Unknown(_) => true, _ => false } }
    #[inline] pub const fn is_unknown_some(&self) -> bool { match self { Self::Unknown(Some(_)) => true, _ => false } }
    #[inline] pub const fn is_unknown_none(&self) -> bool { match self { Self::Unknown(None) => true, _ => false } }
    #[inline] pub const fn is_debug(&self) -> bool { match self { Self::Debug => true, _ => false } }
    #[inline] pub const fn is_http09(&self) -> bool { match self { Self::Http09 => true, _ => false } }
    #[inline] pub const fn is_http10(&self) -> bool { match self { Self::Http10 => true, _ => false } }
    #[inline] pub const fn is_http11(&self) -> bool { match self { Self::Http11 => true, _ => false } }
    #[inline] pub const fn is_http2(&self) -> bool { match self { Self::Http2 => true, _ => false } }
    #[inline] pub const fn is_http3(&self) -> bool { match self { Self::Http3 => true, _ => false } }

    pub const fn associated_type(&self) -> Option<HttpType> {
        use HttpType::*;
        match self {
...
impl Display for HttpMethod{
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            Self::Unknown(s) => if let Some(v) = s { write!(f, "{v}") } else { write!(f, "UKNOWN") },
...
impl HttpMethod{
    ...
    #[inline] pub const fn is_unknown_some(&self) -> bool { match self { Self::Unknown(Some(_)) => true, _ => false } }
    #[inline] pub const fn is_unknown_none(&self) -> bool { match self { Self::Unknown(None) => true, _ => false } }
    #[inline] pub const fn is_get(&self) -> bool { match self { Self::Get => true, _ => false } }
    #[inline] pub const fn is_head(&self) -> bool { match self { Self::Head => true, _ => false } }
    #[inline] pub const fn is_post(&self) -> bool { match self { Self::Post => true, _ => false } }
    #[inline] pub const fn is_put(&self) -> bool { match self { Self::Put => true, _ => false } }
    #[inline] pub const fn is_delete(&self) -> bool { match self { Self::Delete => true, _ => false } }
    #[inline] pub const fn is_connect(&self) -> bool { match self { Self::Connect => true, _ => false } }
    #[inline] pub const fn is_options(&self) -> bool { match self { Self::Options => true, _ => false } }
    #[inline] pub const fn is_trace(&self) -> bool { match self { Self::Trace => true, _ => false } }
}
impl<S: AsRef<str>> From<S> for HttpMethod{
